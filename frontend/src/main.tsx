...
const runtimeConfig = window.__LLM_LENS_CONFIG__ ?? window.__LLM_INSPECTOR_CONFIG__ ?? {};
const API_BASE = runtimeConfig.apiBaseUrl ?? import.meta.env.VITE_LENS_API ?? import.meta.env.VITE_INSPECTOR_API ?? window.location.origin;
const WS_BASE = API_BASE.replace(/^http/, "ws");
const PROXY_URL = runtimeConfig.proxyUrl ?? import.meta.env.VITE_LENS_PROXY_URL ?? import.meta.env.VITE_INSPECTOR_PROXY_URL ?? "http://127.0.0.1:9191";
